...
export const projectsData: ProjectMetrics[] = [
  ...
  },
  {
    ...
    description: "An enterprise-grade educational learning management platform configured with 4 distinct user personas. Built to support robust certification path tracking, it integrates secure badge verifications and detailed progress visualization dashboards.",
    customerDetails: "Confidential Enterprise Client",
  ...
  {
    id: "skillupEdis",
    title: "Education Authority of Ireland Education Platform",
    description: "An enterprise learning management and licensing platform engineered for the Education Authority of Ireland. Built to manage mandatory compliance and teacher certification, the platform features a custom checkpoint-gated media player. Orchestrated high-availability media streaming via CDN, scaling seamlessly to support 24,000 active users with up to 10,000 concurrent users.",
    customerDetails: "Education Authority of Ireland",
    techStack: ["React 19", "Next.js 16", "Vidstack Player", "Azure Web Apps", "Azure Redis", "Azure Front Door", "SQL Server", "OAuth 2.0 / SAML SSO", "Azure AD MFA", "Tailwind CSS v4", "TypeScript"],
    liveLink: "",
    statusTag: "Live",
    projectType: "enterprise",
    screenshotPath: "",
  ...
  },
  {
    ...
    description: "Developed a real-time, responsive enterprise dashboard using DevOps APIs to ingest live metrics for internal users. Designed global state architecture for large payloads using container-level memoization, eliminating unnecessary re-renders.",
    customerDetails: "Confidential Enterprise Tool",
